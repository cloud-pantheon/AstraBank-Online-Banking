...
if (isset($_GET['del_acc'])) {
    ...
    header("Location: admin_overview_.php");
    exit;
}
              ...
              <table class="admin-table">
                ...
                <?php foreach ($accountsList as $a): ?>
                  <tr>
                    ...
                    <td>
                      <a
                        href="admin_overview_.php?del_acc=<?php echo urlencode($a['AccountNo']); ?>"
                        class="danger-link"
              ...
              <table class="admin-table">
                ...
                <?php foreach ($cardsList as $c): ?>
                  <tr>
                    ...
                    <td>
                      <a
                        href="admin_overview_.php?del_card=<?php echo urlencode($c['cardNo']); ?>"
                        class="danger-link"
              ...
              <table class="admin-table">
                ...
                <?php foreach ($billersList as $b): ?>
                  <tr>
                    ...
                    <td>
                      <a
                        href="admin_overview_.php?del_biller=<?php echo urlencode($b['biller_code']); ?>"
                        class="danger-link"
